...
python3 client.py <SERVER_PUBLIC_IP> --port 5000 --method add --a 5 --b 7
python3 client.py <SERVER_PUBLIC_IP> --method reverse --s "Distributed"
...
python3 client.py <SERVER_PUBLIC_IP> --method add --a 1 --b 2 --timeout 2 --retries 3
